...
export class EspecialidadesService {
  ...
  public actualizarEspecialidad(especialidadId:number, especialidad: any){
    let url = `http://localhost:8068/especialidad/${especialidadId}`;
    return this.httpClient.put<any>(url, especialidad);
  }
